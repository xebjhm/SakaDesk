...
2. **Alias source-of-truth file** *(non-blocking)* — you'll provide it (D4); confirm the §6.4 schema or hand me your format and I adapt the loader. Auto-derived **seed** aliases cover Phase 0 meanwhile.
