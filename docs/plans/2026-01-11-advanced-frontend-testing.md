...
Run: `cd ~/repos/Project-PyHako/HakoDesk && uv run pytest tests/test_services_platform.py -v`
...
Run: `mkdir -p ~/repos/Project-PyHako/HakoDesk/backend/fixtures`
...
Run: `cd ~/repos/Project-PyHako/HakoDesk && uv run pytest tests/ -v`
Expected: All tests pass
...
Run:
```bash
cd ~/repos/Project-PyHako/HakoDesk/frontend
...
Run: `mkdir -p ~/repos/Project-PyHako/HakoDesk/frontend/e2e`
...
Run: `cd ~/repos/Project-PyHako/HakoDesk/frontend && npm run test:e2e`
...
Run: `cd ~/repos/Project-PyHako/HakoDesk/frontend && npm run test:run`
...
Run: `cd ~/repos/Project-PyHako/HakoDesk/frontend && npm run test:run -- -u`
...
1. **Run backend tests:**
   ```bash
   cd ~/repos/Project-PyHako/HakoDesk
   uv run pytest -v
   ```
   Expected: All tests pass
