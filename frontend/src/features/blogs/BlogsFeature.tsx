...
type ViewState =
    | { view: 'recent' }
    | { view: 'reader'; blog: BlogMeta; member: BlogMember; content: BlogContentResponse | null; fromView: 'recent' | 'timeline'; searchQuery?: string; matchedTerms?: string[]; readingTerms?: string[] };
        ...
        const openTargetBlog = async () => {
            try {
                ...
                setViewState({
                    ...
                    readingTerms: targetBlog.readingTerms,
                });
            } catch (err) {
            ...
            {viewState.view === 'reader' && (() => {
                ...
                return (
                    <BlogReader
                        ...
                        readingTerms={viewState.readingTerms}
                    />
                );
            })()}
        </div>
