      ...
      <div className="flex-1 min-w-0">
        ...
        {displayContent && (
          processedSnippet ? (
            ...
            // The [m:ss] segment-time prefix is rendered as a sibling text node
            // (not concatenated into the HTML string) so it survives sanitization.
            <p className="text-sm text-gray-500 line-clamp-2 mt-0.5 search-snippet">
              {segmentPrefix}
              <span
